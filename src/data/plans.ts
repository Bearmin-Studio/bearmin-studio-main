...
export const PLANS: Plan[] = [
  {
    ...
    tagline: '小さく始めたい方へ',
    description:
      '毎月2件まで、Excel・スプレッドシート作業の改善や業務システムを制作します。まずは身近な手作業をいくつか減らしたい方におすすめです。',
    audience: '個人事業主・小さく始めたい方',
    audienceDetail: [
      'まずは試してみたい',
      'Excelやスプレッドシート作業をラクにしたい',
      '毎月2件ずつ着実に改善したい',
      '個人事業主・ひとり事業者',
      '作業時間の削減から始めたい',
    ],
  ...
  },
  {
    ...
    description:
      '毎月4件まで制作でき、月1回の改善相談も含まれます。Excel自動化に加え、RPA導入や業務システム構築も相談しながら進められます。',
    audience: '中小事業者・少人数チーム',
    audienceDetail: [
      '毎月の定型作業が多い',
      '転記・集計・確認作業を減らしたい',
      '業務を継続的に仕組み化したい',
...
export const PLAN_NOTES = [
  '最低契約期間は3ヶ月（最低契約期間以降も3ヶ月単位で継続・解約可）',
  '締め日：月末締め／支払日：翌月末日（銀行振込・振込手数料はお客様負担）',
  '未使用分の翌月への繰り越しはありません',
